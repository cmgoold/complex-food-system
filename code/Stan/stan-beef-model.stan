...
transformed data{
  ...
  real b_fix = 249.75; // average cost of production for 2015-2018
  real g_fix = 336.9; // average dressed weight of calves, steers, heifers, young bulls 2015-2019
}
...
model{
  ...
  states_init[1] ~ lognormal( log(y[2,1]/1e5), 0.5);
